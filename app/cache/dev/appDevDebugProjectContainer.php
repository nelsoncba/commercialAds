...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'commercialAds01', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b->setNamespace('sf2orm_default_1bcff7e88b90ab2817426fac172bb902');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_1bcff7e88b90ab2817426fac172bb902');

        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_1bcff7e88b90ab2817426fac172bb902');
        ...
        $f->addDriver($e, 'CommercialAds\\AdvertiserBundle\\Entity');
        $f->addDriver($e, 'CommercialAds\\UserBundle\\Entity');
        $f->addDriver($e, 'CommercialAds\\FilterBundle\\Entity');

        $g = new \Doctrine\ORM\Configuration();
        $g->setEntityNamespaces(array('CommercialAdsAdBundle' => 'CommercialAds\\AdBundle\\Entity', 'CommercialAdsAdvertiserBundle' => 'CommercialAds\\AdvertiserBundle\\Entity', 'CommercialAdsUserBundle' => 'CommercialAds\\UserBundle\\Entity', 'CommercialAdsFilterBundle' => 'CommercialAds\\FilterBundle\\Entity'));
        ...
        $g->addCustomNumericFunction('DEGREES', 'DoctrineExtensions\\Query\\Mysql\\Degrees');
        $g->addCustomNumericFunction('ACOS', 'DoctrineExtensions\\Query\\Mysql\\Acos');
        $g->addCustomNumericFunction('SIN', 'DoctrineExtensions\\Query\\Mysql\\Sin');
        $g->addCustomNumericFunction('RADIANS', 'DoctrineExtensions\\Query\\Mysql\\Radians');
        $g->addCustomNumericFunction('COS', 'DoctrineExtensions\\Query\\Mysql\\Cos');
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), 'a3974dac3192631010b77205219b7871032');
    }
    ...
    {
        $a = new \Metadata\Driver\FileLocator(array('Symfony\\Bundle\\FrameworkBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/config/serializer'), 'Symfony\\Bundle\\SecurityBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/config/serializer'), 'Symfony\\Bundle\\TwigBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/config/serializer'), 'Symfony\\Bundle\\MonologBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\monolog-bundle\\Symfony\\Bundle\\MonologBundle/Resources/config/serializer'), 'Symfony\\Bundle\\SwiftmailerBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\swiftmailer-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\AsseticBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\assetic-bundle\\Symfony\\Bundle\\AsseticBundle/Resources/config/serializer'), 'Doctrine\\Bundle\\DoctrineBundle' => ($this->targetDirs[3].'\\vendor\\doctrine\\doctrine-bundle\\Doctrine\\Bundle\\DoctrineBundle/Resources/config/serializer'), 'Sensio\\Bundle\\FrameworkExtraBundle' => ($this->targetDirs[3].'\\vendor\\sensio\\framework-extra-bundle\\Sensio\\Bundle\\FrameworkExtraBundle/Resources/config/serializer'), 'Doctrine\\Bundle\\FixturesBundle' => ($this->targetDirs[3].'\\vendor\\doctrine\\doctrine-fixtures-bundle\\Doctrine\\Bundle\\FixturesBundle/Resources/config/serializer'), 'Knp\\Bundle\\PaginatorBundle' => ($this->targetDirs[3].'\\vendor\\knplabs\\knp-paginator-bundle/Resources/config/serializer'), 'FOS\\RestBundle' => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\rest-bundle\\FOS\\RestBundle/Resources/config/serializer'), 'JMS\\SerializerBundle' => ($this->targetDirs[3].'\\vendor\\jms\\serializer-bundle\\JMS\\SerializerBundle/Resources/config/serializer'), 'CommercialAds\\AdBundle' => ($this->targetDirs[3].'\\src\\CommercialAds\\AdBundle/Resources/config/serializer'), 'CommercialAds\\AdvertiserBundle' => ($this->targetDirs[3].'\\src\\CommercialAds\\AdvertiserBundle/Resources/config/serializer'), 'CommercialAds\\UserBundle' => ($this->targetDirs[3].'\\src\\CommercialAds\\UserBundle/Resources/config/serializer'), 'CommercialAds\\FilterBundle' => ($this->targetDirs[3].'\\src\\CommercialAds\\FilterBundle/Resources/config/serializer'), 'Acme\\DemoBundle' => ($this->targetDirs[3].'\\src\\Acme\\DemoBundle/Resources/config/serializer'), 'Symfony\\Bundle\\WebProfilerBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/config/serializer'), 'Sensio\\Bundle\\DistributionBundle' => ($this->targetDirs[3].'\\vendor\\sensio\\distribution-bundle\\Sensio\\Bundle\\DistributionBundle/Resources/config/serializer'), 'Sensio\\Bundle\\GeneratorBundle' => ($this->targetDirs[3].'\\vendor\\sensio\\generator-bundle\\Sensio\\Bundle\\GeneratorBundle/Resources/config/serializer')));
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('CommercialAds\\UserBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => true, 2 => 5000))));
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.extranet' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/*'))), $this->get('event_dispatcher'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_ExtranetService()
    {
        ...
        $i = new \Symfony\Component\HttpFoundation\RequestMatcher('^/anunciantes/*');
        ...
        $j->add($i, array(0 => 'ROLE_ADVERTISER'), NULL);
    ...
    protected function getSwiftmailer_Mailer_Default_TransportService()
    {
        ...
        $a->setUsername('nelsonaccorsi84@gmail.com');
        $a->setPassword('hupusyro');
        $a->setAuthMode('login');
    ...
    protected function getTemplating_Helper_LogoutUrlService()
    {
        ...
        $instance->registerListener('extranet', '/logout', 'logout', '_csrf_token', NULL);
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\CommercialAds\\AdBundle/Resources/views'), 'CommercialAdsAd');
        $instance->addPath(($this->targetDirs[3].'\\src\\CommercialAds\\AdvertiserBundle/Resources/views'), 'CommercialAdsAdvertiser');
        $instance->addPath(($this->targetDirs[3].'\\src\\CommercialAds\\UserBundle/Resources/views'), 'CommercialAdsUser');
        $instance->addPath(($this->targetDirs[3].'\\src\\CommercialAds\\FilterBundle/Resources/views'), 'CommercialAdsFilter');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('a3974dac3192631010b77205219b7871032');
    }
    ...
    {
        return $this->services['security.user.provider.concrete.user'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'CommercialAds\\UserBundle\\Entity\\User', 'email', NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'CommercialAdsAdBundle' => 'CommercialAds\\AdBundle\\CommercialAdsAdBundle',
                'CommercialAdsAdvertiserBundle' => 'CommercialAds\\AdvertiserBundle\\CommercialAdsAdvertiserBundle',
                'CommercialAdsUserBundle' => 'CommercialAds\\UserBundle\\CommercialAdsUserBundle',
                'CommercialAdsFilterBundle' => 'CommercialAds\\FilterBundle\\CommercialAdsFilterBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'commercialAds01',
            'database_user' => 'root',
            'database_password' => NULL,
            'mailer_transport' => 'gmail',
            'mailer_host' => NULL,
            'mailer_user' => 'nelsonaccorsi84@gmail.com',
            'mailer_password' => 'hupusyro',
            'locale' => 'es',
            'secret' => 'a3974dac3192631010b77205219b7871032',
            ...
            'kernel.secret' => 'a3974dac3192631010b77205219b7871032',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'nelsonaccorsi84@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'hupusyro',
