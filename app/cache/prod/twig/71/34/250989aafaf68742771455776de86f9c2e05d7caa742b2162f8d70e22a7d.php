...
$context["category"], "id", array()) == 16))) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["subcategory"]) {
                ...
                if (($this->getAttribute($context["category"], "id", array()) == $this->getAttribute($this->getAttribute($context["subcategory"], "category", array()), "id", array()))) {
                    // line 12
                    echo "                        ";
                    if (((isset($context["city"]) ? $context["city"] : null) && (isset($context["region"]) ? $context["region"] : null))) {
                        // line 13
                        echo "                    <li><a class=\"subcat-link\" href=\"";
                        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("ad_city_subcat", array("region" => (isset($context["region"]) ? $context["region"] : null), "city" => (isset($context["city"]) ? $context["city"] : null), "category" => $this->getAttribute($this->getAttribute($context["subcategory"], "category", array()), "slug", array()), "subcategory" => $this->getAttribute($context["subcategory"], "slug", array()))), "html", null, true);
                        echo "\"  title=\"";
...
(isset($context["region"]) ? $context["region"] : null)) {
                        // line 19
                        echo "                            <li><a class=\"subcat-link\" href=\"";
                        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("ad_region_subcat", array("region" => (isset($context["region"]) ? $context["region"] : null), "category" => $this->getAttribute($this->getAttribute($context["subcategory"], "category", array()), "slug", array()), "subcategory" => $this->getAttribute($context["subcategory"], "slug", array()))), "html", null, true);
                        echo "\"  title=\"";
                        echo twig_escape_filter($this->env, $this->getAttribute($context["subcategory"], "id", array()), "html", null, true);
                        echo "\"><span class=\"item-subcategoria\" data-id-subcat=\"";
                        echo twig_escape_filter($this->env, $this->getAttribute($context["subcategory"], "id", array()), "html", null, true);
...
(isset($context["lat"]) ? $context["lat"] : null) && (isset($context["lng"]) ? $context["lng"] : null))) {
                        // line 25
                        echo "                            <li><a class=\"subcat-link\" href=\"";
                        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("near_coords_subcat", array("lat" => (isset($context["lat"]) ? $context["lat"] : null), "lng" => (isset($context["lng"]) ? $context["lng"] : null), "category" => $this->getAttribute($this->getAttribute($context["subcategory"], "category", array()), "slug", array()), "subcategory" => $this->getAttribute($context["subcategory"], "slug", array()))), "html", null, true);
                        echo "\"  title=\"";
                        echo twig_escape_filter($this->env, $this->getAttribute($context["subcategory"], "id", array()), "html", null, true);
                        echo "\"><span class=\"item-subcategoria\" data-id-subcat=\"";
                        echo twig_escape_filter($this->env, $this->getAttribute($context["subcategory"], "id", array()), "html", null, true);
