...
";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["region"]) {
            ...
            echo "\"";
            if ((isset($context["subcategory"]) ? $context["subcategory"] : null)) {
                echo "data-url=\"";
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("ad_region_subcat", array("region" => $this->getAttribute($context["region"], "slug", array()), "category" => (isset($context["category"]) ? $context["category"] : null), "subcategory" => (isset($context["subcategory"]) ? $context["subcategory"] : null))), "html", null, true);
                echo "\"";
            } else {
                echo "data-url=\"";
            ...
            echo ((((isset($context["currentRegion"]) ? $context["currentRegion"] : null) == $this->getAttribute($context["region"], "slug", array()))) ? ("selected=\"selected\"") : (""));
            echo ">
      ";
            // line 7
